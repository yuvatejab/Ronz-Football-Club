import React, { ElementType, ReactNode, useEffect, useRef, useState, useId } from "react";
...
export function VideoText({
  ...
  return (
    <Component className={cn("relative w-full h-full min-h-[200px] sm:min-h-[280px] md:min-h-[360px] flex items-center justify-center overflow-hidden select-none", className)}>
      ...
      >
        <defs>
          <mask id={`vmask-${maskId}`} maskUnits="userSpaceOnUse" x="0" y="0" width="1000" height="280">
